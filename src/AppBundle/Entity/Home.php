...
//------------------------------------------------------------------------------
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\LeEvent", mappedBy="home")
     */
    private $leEvent;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Post", mappedBy="home")
     */
    private $post;

    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\LeShow", mappedBy="home")
     */
    private $leShow;
