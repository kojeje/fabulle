<?php
  ...
  class AdminMemberController extends Controller
  {
    ...
    /**
     * @Route("/admin/create_member", name="create_member")
     */

    public function formCreateMember(Request $request)
...
//                /* Je redirige ensuite sur la liste des members*/
//                return $this->redirectToRoute('admin_members');
      }

      /* Quand j'arrive sur la route "create_member" je vais directement sur le formulaire dont les champs sont définis dans le memberType,
      et qui seront affichés dans la twig*/
      return $this->render('@App/admin/CreateMember.html.twig',
        [
